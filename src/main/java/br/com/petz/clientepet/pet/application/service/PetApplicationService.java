...
public class PetApplicationService implements PetService{
	...
	@Override
	public void patchAlteraPet(UUID idCliente, UUID idPet, PetAlteracaoRequest petAlteracaoRequest) {
		log.info("[inicia] PetApplicationService - patchAlteraPet");
		clienteService.buscaClienteAtravesId(idCliente);
		Pet pet = petRepository.buscaPetPeloId(idPet);
		pet.altera(petAlteracaoRequest);
		petRepository.salvaPet(pet);
		log.info("[finaliza] PetApplicationService - patchAlteraPet");
